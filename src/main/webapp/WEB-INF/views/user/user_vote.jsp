...
<div class="frame">
    <%-- 6, 8 markup --%>
    <div id="uservote_1" style="display: block;">
        <div style="width: 400px; border: 1px solid black; margin: 20px auto; padding: 20px 10px; text-align: center;">
            <div>${vote_name}</div>
            <div>투표 시작 : ${start_date}</div>
            <div>투표 종료 : ${end_date}</div>
        </div>

        <div class="d-flex justify-content-center" style="margin: 15px;">
            <button onclick="movePage_vote(2)" style="width: 400px; line-height: 50px; margin: 20px auto; padding: 20px 10px; text-align: center; border-radius: 13px; background-color: #0d6efd; color: white; font-size: 1.2rem;">
            학생회장 투표
            </button>
        </div>
    ...
    <%-- 7 markup --%>
    <div id="uservote_2" style="display: none;">
        <div style="width: 400px; border: 1px solid black; margin: 20px auto; padding: 20px 10px; text-align: center;">
        ...
        <div style="width: 400px; max-height: 380px; border: 1px solid black; margin: 20px auto; padding: 20px 40px; text-align: center; overflow: auto;">
            <div class="d-flex bd-highlight mb-3" style="height: 100px">
                ...
                <div class="p-2 bd-highlight" style="width: 100px; height: 100px; border: 1px solid black;">${img_path}</div>
            </div>
            <div class="d-flex bd-highlight mb-3" style="height: 100px">
                <div class="align-self-center p-2 bd-highlight">
                    <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
        ...
        <div class="d-flex justify-content-center" style="margin: 15px">
            <button type="button" class="btn btn-primary btn-lg" onclick="location.href='UserResult=${manager_id}'">투표 완료</button>
        </div>
    </div>
...
<script>
    function movePage_vote(Destination)
    {
        const page1 = document.getElementById('uservote_1')
        const page2 = document.getElementById('uservote_2')
